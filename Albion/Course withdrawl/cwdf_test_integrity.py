...
def insert_file():
    ...
    df = df[['RecordedDate','Q1_1','Q2','Q3_1','Q3_2','Q4_1','Q4_2','Q5_1','Q5_2','Q10']] #Based on columns needed to automate 
    df['Q1_1'] = df['Q1_1'].apply(lambda x: '{0:0>9}'.format(x))
    df['Q2'] = df['Q2'].str.replace(r'[^(]*\(|\)[^)]*', '')
    df['Course'] = df['Q3_1'].astype(str)+'_'+df['Q4_1']+'_'+df['Q5_1'] #combining 3 column Based on termcode availibility on Qualtrics
    df['TIC'] = df['Q3_2'].astype(str)+'_'+df['Q4_2']+'_'+df['Q5_2'] #combining 3 column Based on termcode availibility on Qualtrics
    ...
    drp_df = ['Q3_1','Q4_1','Q5_1','Q3_2','Q4_2','Q5_2']
